    ...
    <div class="container">
        ...
        <div class="checkout" id="checkoutFormContainer">
            ...
            <form class="checkout-form" id="checkoutForm" method="POST" action="process_order.php">
                <p>আপনার নাম<br><input class="input" type="text" name="name" placeholder="সম্পূর্ণ নাম লিখুন" required>
                </p>
                <p>আপনার মোবাইল<br><input class="input" type="text" name="mobile" placeholder="017XXXXXXXX" required>
                </p>
                <p>আপনার ঠিকানা<br><input class="input" type="text" name="address"
                        placeholder="বাসা নাম্বার, গ্রাম, ইউনিয়ন, থানা, জেলা" required></p>
